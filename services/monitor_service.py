...
class MonitorService:
    def __init__(self, apple_service: AppleService, notify_service: NotifyService, monitor_setting: dict, product_list: dict):
    ...
    def monitor_task(self, product_id, error_delay, monitor_delay):
        ...
        while True:
            if not self.on_error:
                status_code, json_data = self.apple_service.get_data(product_id, near_zip)
